...
var (
	...
	styleBannerA   = lipgloss.NewStyle().Foreground(lipgloss.Color("5")).Bold(true)
	...
	styleInputBox  = lipgloss.NewStyle().Border(asciiBorder).BorderForeground(lipgloss.Color("8")).Padding(0, 1)
	styleInputOn   = lipgloss.NewStyle().Border(asciiBorder).BorderForeground(lipgloss.Color("6")).Padding(0, 1)
)
